(function () {
	...
	*/
	...
	const Home = () => {
	  return /*#__PURE__*/jsxRuntime.jsxs("div", {
	    ...
	    children: [/*#__PURE__*/jsxRuntime.jsx("h1", {
	      ...
	      children: "Delta Simulations KC-135R"
	...
	function createMemoryHistory(options) {
	  ...
	  var index = clamp$1(initialIndex == null ? entries.length - 1 : initialIndex, 0, entries.length - 1);
	  ...
	  function go(delta) {
	    var nextIndex = clamp$1(index + delta, 0, entries.length - 1);
	...
	const _excluded$d = ["onClick", "reloadDocument", "replace", "state", "target", "to"],
	...
	const Link = /*#__PURE__*/react.forwardRef(function LinkWithRef(_ref3, ref) {
	  let {
	    ...
	    to
	      ...
	      rest = _objectWithoutPropertiesLoose$1(_ref3, _excluded$d);
	...
	*/
	...
	const _excluded$b = ["values", "unit", "step"]; // Sorted ASC by size. That's important.
	...
	const _excluded$4 = ["duration", "easing", "delay"]; // Follow https://material.google.com/motion/duration-easing.html#duration-easing-natural-easing-curves
